...
class RouteUrlGenerator
{
    ...
    protected static $arrayAttriForObj=['defaultParameters'];
    ...
    protected function replaceNamedParameters($path, &$parameters)
    {
        return preg_replace_callback('/\{(.*?)\??\}/', function ($m) use (&$parameters) {
            ...
            } elseif (isset(static::$corDict[$cid=\Swoole\Coroutine::getuid()]['defaultParameters'][$m[1]])) {
                return static::$corDict[$cid]['defaultParameters'][$m[1]];
            }
    ...
    public function defaults(array $defaults)
    {
        ...
        $dict['defaultParameters'] = array_merge(
            $dict['defaultParameters'], $defaults
        );
    }
}
