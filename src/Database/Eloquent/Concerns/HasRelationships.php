...
trait HasRelationships
{
    ...
    function cloneRelationshipCache($currentCache)
    {


        /**
         * @var Relation|HasOneOrMany $r
         */
        $r = clone $currentCache;
        ...
        (function () use ( $parent) {
            ...
            // no clone for builder. because Eloquent Builder and base Builder have been cloned when last statement
            // $this->query = clone $this->query;

            /**
             * @var Model $instance
             */
            $instance = $this->related = clone $this->related;
            ...
            // the key statement, how to hack it?
            $this->addConstraints();
    ...
    function cloneRelationshipCacheWithChild($currentCache)
    {
    ...
    function saveRelationshipCache(&$cache, $cacheKey, $clonedQuery, $r)
    {
        $clonedR = clone $r;

        (function () use ($clonedQuery) {
                                  ...
                                  $parentKey = null, $relatedKey = null, $relation = null)
    {
        ...
        $query = $instance->newQuery();
        $clonedQuery = clone $query;
        $r = $this->newBelongsToMany(
            $query, $this, $table, $foreignPivotKey,
