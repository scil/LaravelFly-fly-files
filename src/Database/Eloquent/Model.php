...
abstract class Model implements Arrayable, ArrayAccess, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
    ...
    {
        if (!isset(static::$corStaticDict[\Swoole\Coroutine::getuid()]['booted'][static::class])) {
            static::$corStaticDict[\Swoole\Coroutine::getuid()]['booted'][static::class] = true;
    ...
    {
        $class = static::class;
        if (isset(static::$traitsBoots[$class])) {
            foreach (static::$traitsBoots[$class] as $traitBoot) {
                forward_static_call($traitBoot);
            }
            return;
        }

        static::$traitsBoots[$class] = [];
        $traitBoots = &static::$traitsBoots[$class];
    ...
    {
        static::$corStaticDict[\Swoole\Coroutine::getuid()]['booted'] = [];
    ...
    public function getTable()
    {
        ...
        return $this->table ?? static::$tableNames[static::class] ??
         (  
            static::$tableNames[static::class] = Str::snake(Str::pluralStudly(class_basename($this)))
             ) ;
