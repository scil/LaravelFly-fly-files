...
trait InteractsWithInput
{
    ...
    public function keys()
    {
        ...
        return array_merge(array_keys($this->input()), $dict['files']->keys());
    }
    ...
    public function input($key = null, $default = null)
    {
        $dict = &static::$corDict[\Swoole\Coroutine::getuid()];
        return data_get(
            $this->getInputSource()->all() + $dict['query']->all(), $key, $default
        );
    }
    ...
    protected function retrieveItem($source, $key, $default)
    {
        ...
        if (is_null($key)) {
            return $dict[$source]->all();
        }

        return $dict[$source]->get($key, $default);
    }
}
